...
public:
    ...
    ChatCommand* GetCommands() const
    {
        ...
        {
            { "add",            SEC_OWNER,  false, &HandleQuestAdd,                    "", NULL },
            { "complete",       SEC_OWNER,  false, &HandleQuestComplete,               "", NULL },
            { "remove",         SEC_OWNER,  false, &HandleQuestRemove,                 "", NULL },
            { NULL,             0,                  false, NULL,                               "", NULL }
        };
        static ChatCommand commandTable[] =
        {
            { "quest",          SEC_OWNER,  false, NULL,                  "", questCommandTable },
            { NULL,             0,                  false, NULL,                               "", NULL }
        };
        return commandTable;
    }
