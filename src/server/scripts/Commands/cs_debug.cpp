...
public:
	...
	ChatCommand* GetCommands() const
	{
		...
		{
			{ "cinematic",      SEC_TRIAL_GM,      false, &HandleDebugPlayCinematicCommand,   "", NULL },
			{ "movie",          SEC_TRIAL_GM,      false, &HandleDebugPlayMovieCommand,       "", NULL },
			{ "sound",          SEC_TRIAL_GM,      false, &HandleDebugPlaySoundCommand,       "", NULL },
			{ NULL,             0,                  false, NULL,                               "", NULL }
		};
		static ChatCommand debugSendCommandTable[] =
		{
			{ "buyerror",       SEC_OWNER,  false, &HandleDebugSendBuyErrorCommand,       "", NULL },
			{ "channelnotify",  SEC_OWNER,  false, &HandleDebugSendChannelNotifyCommand,  "", NULL },
			{ "chatmmessage",   SEC_OWNER,  false, &HandleDebugSendChatMsgCommand,        "", NULL },
			{ "equiperror",     SEC_OWNER,  false, &HandleDebugSendEquipErrorCommand,     "", NULL },
			{ "largepacket",    SEC_OWNER,  false, &HandleDebugSendLargePacketCommand,    "", NULL },
			{ "opcode",         SEC_OWNER,  false, &HandleDebugSendOpcodeCommand,         "", NULL },
			{ "qpartymsg",      SEC_OWNER,  false, &HandleDebugSendQuestPartyMsgCommand,  "", NULL },
			{ "qinvalidmsg",    SEC_OWNER,  false, &HandleDebugSendQuestInvalidMsgCommand, "", NULL },
			{ "sellerror",      SEC_OWNER,  false, &HandleDebugSendSellErrorCommand,      "", NULL },
			{ "setphaseshift",  SEC_OWNER,  false, &HandleDebugSendSetPhaseShiftCommand,  "", NULL },
			{ "spellfail",      SEC_OWNER,  false, &HandleDebugSendSpellFailCommand,      "", NULL },
			{ NULL,             0,                  false, NULL,                                  "", NULL }
		};
		static ChatCommand debugCommandTable[] =
		{
			{ "setbit",         SEC_OWNER,  false, &HandleDebugSet32BitCommand,        "", NULL },
			{ "threat",         SEC_OWNER,  false, &HandleDebugThreatListCommand,      "", NULL },
			{ "hostil",         SEC_OWNER,  false, &HandleDebugHostileRefListCommand,  "", NULL },
			{ "anim",           SEC_GM ,     false, &HandleDebugAnimCommand,            "", NULL },
			{ "arena",          SEC_OWNER,  false, &HandleDebugArenaCommand,           "", NULL },
			{ "bg",             SEC_OWNER,  false, &HandleDebugBattlegroundCommand,    "", NULL },
			{ "getitemstate",   SEC_OWNER,  false, &HandleDebugGetItemStateCommand,    "", NULL },
			{ "lootrecipient",  SEC_GM ,     false, &HandleDebugGetLootRecipientCommand, "", NULL },
			{ "getvalue",       SEC_OWNER,  false, &HandleDebugGetValueCommand,        "", NULL },
			{ "getitemvalue",   SEC_OWNER,  false, &HandleDebugGetItemValueCommand,    "", NULL },
			{ "Mod32Value",     SEC_OWNER,  false, &HandleDebugMod32ValueCommand,      "", NULL },
			{ "play",           SEC_TRIAL_GM,      false, NULL,              "", debugPlayCommandTable },
			{ "send",           SEC_OWNER,  false, NULL,              "", debugSendCommandTable },
			{ "setaurastate",   SEC_OWNER,  false, &HandleDebugSetAuraStateCommand,    "", NULL },
			{ "setitemvalue",   SEC_OWNER,  false, &HandleDebugSetItemValueCommand,    "", NULL },
			{ "setvalue",       SEC_OWNER,  false, &HandleDebugSetValueCommand,        "", NULL },
			{ "spawnvehicle",   SEC_OWNER,  false, &HandleDebugSpawnVehicleCommand,    "", NULL },
			{ "setvid",         SEC_OWNER,  false, &HandleDebugSetVehicleIdCommand,    "", NULL },
			{ "entervehicle",   SEC_OWNER,  false, &HandleDebugEnterVehicleCommand,    "", NULL },
			{ "uws",            SEC_OWNER,  false, &HandleDebugUpdateWorldStateCommand, "", NULL },
			{ "update",         SEC_OWNER,  false, &HandleDebugUpdateCommand,          "", NULL },
			{ "itemexpire",     SEC_OWNER,  false, &HandleDebugItemExpireCommand,      "", NULL },
			{ "areatriggers",   SEC_OWNER,  false, &HandleDebugAreaTriggersCommand,    "", NULL },
			{ NULL,             0,                  false, NULL,                               "", NULL }
		};
		static ChatCommand commandTable[] =
		{
			{ "debug",          SEC_TRIAL_GM,      true,  NULL,                  "", debugCommandTable },
			{ NULL,             0,                  false, NULL,                               "", NULL }
		};
		return commandTable;
	}
