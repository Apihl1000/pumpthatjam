...
public:
    ...
    ChatCommand* GetCommands() const
    {
        ...
        {
            { "temp",           SEC_GM ,     false, &HandleGameObjectAddTempCommand,   "", NULL },
            { "",               SEC_GM ,     false, &HandleGameObjectAddCommand,       "", NULL },
            { NULL,             0,                  false, NULL,                              "", NULL }
        };
        static ChatCommand gobjectSetCommandTable[] =
        {
            { "phase",          SEC_GM ,     false, &HandleGameObjectSetPhaseCommand,  "", NULL },
            { "state",          SEC_GM ,     false, &HandleGameObjectSetStateCommand,  "", NULL },
            { NULL,             0,                  false, NULL,                              "", NULL }
        };
        static ChatCommand gobjectCommandTable[] =
        {
            { "activate",       SEC_GM ,     false, &HandleGameObjectActivateCommand,  "", NULL },
            { "delete",         SEC_GM ,     false, &HandleGameObjectDeleteCommand,    "", NULL },
            { "info",           SEC_GM ,     false, &HandleGameObjectInfoCommand,      "", NULL },
            { "move",           SEC_GM ,     false, &HandleGameObjectMoveCommand,      "", NULL },
            { "near",           SEC_GM ,     false, &HandleGameObjectNearCommand,      "", NULL },
            { "target",         SEC_GM ,     false, &HandleGameObjectTargetCommand,    "", NULL },
            { "turn",           SEC_GM ,     false, &HandleGameObjectTurnCommand,      "", NULL },
            { "add",            SEC_GM ,     false, NULL,            "", gobjectAddCommandTable },
            { "set",            SEC_GM ,     false, NULL,            "", gobjectSetCommandTable },
            { NULL,             0,                  false, NULL,                              "", NULL }
        };
        static ChatCommand commandTable[] =
        {
            { "gobject",        SEC_GM ,     false, NULL,                "", gobjectCommandTable },
            { NULL,             0,                  false, NULL,                               "", NULL }
        };
        return commandTable;
    }
