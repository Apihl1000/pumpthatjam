...
public:
    ...
    ChatCommand* GetCommands() const
    {
        ...
        {
            { "add",            SEC_GM ,     false, &HandleWpAddCommand,                "", NULL },
            { "event",          SEC_GM ,     false, &HandleWpEventCommand,              "", NULL },
            { "load",           SEC_GM ,     false, &HandleWpLoadCommand,               "", NULL },
            { "modify",         SEC_GM ,     false, &HandleWpModifyCommand,             "", NULL },
            { "unload",         SEC_GM ,     false, &HandleWpUnLoadCommand,             "", NULL },
            { "reload",         SEC_OWNER,  false, &HandleWpReloadCommand,             "", NULL },
            { "show",           SEC_GM ,     false, &HandleWpShowCommand,               "", NULL },
            { NULL,             0,                  false, NULL,                               "", NULL }
        };
        static ChatCommand commandTable[] =
        {
            { "wp",             SEC_GM ,     false, NULL,                     "", wpCommandTable },
            { NULL,             0,                  false, NULL,                               "", NULL }
        };
        return commandTable;
    }
