...
public:
    ...
    ChatCommand* GetCommands() const
    {
        ...
        {
            { "addon",          SEC_CONSOLE,  true,  &HandleAccountSetAddonCommand,     "", NULL },
        ...
        {
            { "addon",          SEC_TRIAL_GM,      false, &HandleAccountAddonCommand,        "", NULL },
            ...
            { "set",            SEC_OWNER,  true,  NULL,            "", accountSetCommandTable },
...
class cs_o_world_chat : public CommandScript
{
public:
    cs_o_world_chat() : CommandScript("cs_o_world_chat"){}

    ChatCommand * GetCommands() const
    {
        static ChatCommand WorldChatCommandTable[] =
        {
            { "o", SEC_PLAYER, true, &HandleWorldChatCommand, "", NULL },
            { NULL, 0, false, NULL, "", NULL }
        };
    ...
    static bool HandleWorldChatCommand(ChatHandler * handler, const char * args)
    {
        ...
        case SEC_PLAYER:
          ...
          // gm
        case SEC_GM:
            msg += "|cffff8a00[Game Master] ";
            msg += player->GetName();
            msg += " |cfffaeb00";
            break;
            // dev 
        case SEC_DEVELOPER:
            msg += "|cff00ffff[Developer] ";
            msg += player->GetName();
            msg += " |cfffaeb00";
            break;
            // head dev
