...
public:
    ...
    ChatCommand* GetCommands() const
    {
        ...
        {
            { "kill",           SEC_GM ,     false, &HandleHonorAddKillCommand,         "", NULL },
            { "",               SEC_GM ,     false, &HandleHonorAddCommand,             "", NULL },
            { NULL,             0,                  false, NULL,                               "", NULL }
        };
        static ChatCommand honorCommandTable[] =
        {
            { "add",            SEC_GM ,     false, NULL,               "", honorAddCommandTable },
            { "update",         SEC_GM ,     false, &HandleHonorUpdateCommand,          "", NULL },
            { NULL,             0,                  false, NULL,                               "", NULL }
        };
        static ChatCommand commandTable[] =
        {
            { "honor",          SEC_GM ,     false, NULL,                  "", honorCommandTable },
            { NULL,             0,                  false, NULL,                               "", NULL }
        };
        return commandTable;
    }
