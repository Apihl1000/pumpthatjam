...
public:
    ...
    ChatCommand* GetCommands() const
    {
        ...
        {
            { "achievement",SEC_OWNER,  true,  &HandleReloadAllAchievementCommand,"", NULL },
            { "area",       SEC_OWNER,  true,  &HandleReloadAllAreaCommand,       "", NULL },
            { "eventai",    SEC_OWNER,  true,  &HandleReloadAllEventAICommand,    "", NULL },
            { "gossips",    SEC_OWNER,  true,  &HandleReloadAllGossipsCommand,    "", NULL },
            { "item",       SEC_OWNER,  true,  &HandleReloadAllItemCommand,       "", NULL },
            { "locales",    SEC_OWNER,  true,  &HandleReloadAllLocalesCommand,    "", NULL },
            { "loot",       SEC_OWNER,  true,  &HandleReloadAllLootCommand,       "", NULL },
            { "npc",        SEC_OWNER,  true,  &HandleReloadAllNpcCommand,        "", NULL },
            { "quest",      SEC_OWNER,  true,  &HandleReloadAllQuestCommand,      "", NULL },
            { "scripts",    SEC_OWNER,  true,  &HandleReloadAllScriptsCommand,    "", NULL },
            { "spell",      SEC_OWNER,  true,  &HandleReloadAllSpellCommand,      "", NULL },
            { "",           SEC_OWNER,  true,  &HandleReloadAllCommand,           "", NULL },
            { NULL,         0,                  false, NULL,                              "", NULL }
        };
        static ChatCommand reloadCommandTable[] =
        {
            { "auctions",                     SEC_OWNER, true,  &HandleReloadAuctionsCommand,                   "", NULL },
            { "access_requirement",           SEC_OWNER, true,  &HandleReloadAccessRequirementCommand,          "", NULL },
            { "achievement_criteria_data",    SEC_OWNER, true,  &HandleReloadAchievementCriteriaDataCommand,    "", NULL },
            { "achievement_reward",           SEC_OWNER, true,  &HandleReloadAchievementRewardCommand,          "", NULL },
            { "all",                          SEC_OWNER, true,  NULL,                          "", reloadAllCommandTable },
            { "areatrigger_involvedrelation", SEC_OWNER, true,  &HandleReloadQuestAreaTriggersCommand,          "", NULL },
            { "areatrigger_tavern",           SEC_OWNER, true,  &HandleReloadAreaTriggerTavernCommand,          "", NULL },
            { "areatrigger_teleport",         SEC_OWNER, true,  &HandleReloadAreaTriggerTeleportCommand,        "", NULL },
            { "autobroadcast",                SEC_OWNER, true,  &HandleReloadAutobroadcastCommand,              "", NULL },
            { "command",                      SEC_OWNER, true,  &HandleReloadCommandCommand,                    "", NULL },
            { "conditions",                   SEC_OWNER, true,  &HandleReloadConditions,                        "", NULL },
            { "config",                       SEC_OWNER, true,  &HandleReloadConfigCommand,                     "", NULL },
            { "creature_text",                SEC_OWNER, true,  &HandleReloadCreatureText,                      "", NULL },
            { "creature_ai_scripts",          SEC_OWNER, true,  &HandleReloadEventAIScriptsCommand,             "", NULL },
            { "creature_ai_summons",          SEC_OWNER, true,  &HandleReloadEventAISummonsCommand,             "", NULL },
            { "creature_ai_texts",            SEC_OWNER, true,  &HandleReloadEventAITextsCommand,               "", NULL },
            { "creature_involvedrelation",    SEC_OWNER, true,  &HandleReloadCreatureQuestInvRelationsCommand,  "",NULL },
            { "creature_linked_respawn",      SEC_OWNER ,    true,  &HandleReloadLinkedRespawnCommand,              "", NULL },
            { "creature_loot_template",       SEC_OWNER, true,  &HandleReloadLootTemplatesCreatureCommand,      "", NULL },
            { "creature_onkill_reputation",   SEC_OWNER, true,  &HandleReloadOnKillReputationCommand,           "", NULL },
            { "creature_questrelation",       SEC_OWNER, true,  &HandleReloadCreatureQuestRelationsCommand,     "", NULL },
            { "creature_template",            SEC_OWNER, true,  &HandleReloadCreatureTemplateCommand,           "", NULL },
            //{ "db_script_string",             SEC_OWNER, true,  &HandleReloadDbScriptStringCommand,            "", NULL },
            { "disables",                     SEC_OWNER, true,  &HandleReloadDisablesCommand,                   "", NULL },
            { "disenchant_loot_template",     SEC_OWNER, true,  &HandleReloadLootTemplatesDisenchantCommand,    "", NULL },
            { "event_scripts",                SEC_OWNER, true,  &HandleReloadEventScriptsCommand,               "", NULL },
            { "fishing_loot_template",        SEC_OWNER, true,  &HandleReloadLootTemplatesFishingCommand,       "", NULL },
            { "game_graveyard_zone",          SEC_OWNER, true,  &HandleReloadGameGraveyardZoneCommand,          "", NULL },
            { "game_tele",                    SEC_OWNER, true,  &HandleReloadGameTeleCommand,                   "", NULL },
            { "gameobject_involvedrelation",  SEC_OWNER, true,  &HandleReloadGOQuestInvRelationsCommand,        "", NULL },
            { "gameobject_loot_template",     SEC_OWNER, true,  &HandleReloadLootTemplatesGameobjectCommand,    "", NULL },
            { "gameobject_questrelation",     SEC_OWNER, true,  &HandleReloadGOQuestRelationsCommand,           "", NULL },
            { "gameobject_scripts",           SEC_OWNER, true,  &HandleReloadGameObjectScriptsCommand,          "", NULL },
            { "gm_tickets",                   SEC_OWNER, true,  &HandleReloadGMTicketsCommand,                  "", NULL },
            { "gossip_menu",                  SEC_OWNER, true,  &HandleReloadGossipMenuCommand,                 "", NULL },
            { "gossip_menu_option",           SEC_OWNER, true,  &HandleReloadGossipMenuOptionCommand,           "", NULL },
            { "gossip_scripts",               SEC_OWNER, true,  &HandleReloadGossipScriptsCommand,              "", NULL },
            { "item_enchantment_template",    SEC_OWNER, true,  &HandleReloadItemEnchantementsCommand,          "", NULL },
            { "item_loot_template",           SEC_OWNER, true,  &HandleReloadLootTemplatesItemCommand,          "", NULL },
            { "item_set_names",               SEC_OWNER, true,  &HandleReloadItemSetNamesCommand,               "", NULL },
            { "lfg_dungeon_rewards",          SEC_OWNER, true,  &HandleReloadLfgRewardsCommand,                 "", NULL },
            { "locales_achievement_reward",   SEC_OWNER, true,  &HandleReloadLocalesAchievementRewardCommand,   "", NULL },
            { "locales_creature",             SEC_OWNER, true,  &HandleReloadLocalesCreatureCommand,            "", NULL },
            { "locales_gameobject",           SEC_OWNER, true,  &HandleReloadLocalesGameobjectCommand,          "", NULL },
            { "locales_gossip_menu_option",   SEC_OWNER, true,  &HandleReloadLocalesGossipMenuOptionCommand,    "", NULL },
            { "locales_item",                 SEC_OWNER, true,  &HandleReloadLocalesItemCommand,                "", NULL },
            { "locales_item_set_name",        SEC_OWNER, true,  &HandleReloadLocalesItemSetNameCommand,         "", NULL },
            { "locales_npc_text",             SEC_OWNER, true,  &HandleReloadLocalesNpcTextCommand,             "", NULL },
            { "locales_page_text",            SEC_OWNER, true,  &HandleReloadLocalesPageTextCommand,            "", NULL },
            { "locales_points_of_interest",   SEC_OWNER, true,  &HandleReloadLocalesPointsOfInterestCommand,    "", NULL },
            { "locales_quest",                SEC_OWNER, true,  &HandleReloadLocalesQuestCommand,               "", NULL },
            { "mail_level_reward",            SEC_OWNER, true,  &HandleReloadMailLevelRewardCommand,            "", NULL },
            { "mail_loot_template",           SEC_OWNER, true,  &HandleReloadLootTemplatesMailCommand,          "", NULL },
            { "milling_loot_template",        SEC_OWNER, true,  &HandleReloadLootTemplatesMillingCommand,       "", NULL },
            { "npc_spellclick_spells",        SEC_OWNER, true,  &HandleReloadSpellClickSpellsCommand,           "",NULL},
            { "npc_trainer",                  SEC_OWNER, true,  &HandleReloadNpcTrainerCommand,                 "", NULL },
            { "npc_vendor",                   SEC_OWNER, true,  &HandleReloadNpcVendorCommand,                  "", NULL },
            { "page_text",                    SEC_OWNER, true,  &HandleReloadPageTextsCommand,                  "", NULL },
            { "pickpocketing_loot_template",  SEC_OWNER, true,  &HandleReloadLootTemplatesPickpocketingCommand, "",NULL},
            { "points_of_interest",           SEC_OWNER, true,  &HandleReloadPointsOfInterestCommand,           "", NULL },
            { "prospecting_loot_template",    SEC_OWNER, true,  &HandleReloadLootTemplatesProspectingCommand,   "", NULL },
            { "quest_end_scripts",            SEC_OWNER, true,  &HandleReloadQuestEndScriptsCommand,            "", NULL },
            { "quest_poi",                    SEC_OWNER, true,  &HandleReloadQuestPOICommand,                   "", NULL },
            { "quest_start_scripts",          SEC_OWNER, true,  &HandleReloadQuestStartScriptsCommand,          "", NULL },
            { "quest_template",               SEC_OWNER, true,  &HandleReloadQuestTemplateCommand,              "", NULL },
            { "reference_loot_template",      SEC_OWNER, true,  &HandleReloadLootTemplatesReferenceCommand,     "", NULL },
            { "reserved_name",                SEC_OWNER, true,  &HandleReloadReservedNameCommand,               "", NULL },
            { "reputation_reward_rate",       SEC_OWNER, true,  &HandleReloadReputationRewardRateCommand,       "", NULL },
            { "reputation_spillover_template",SEC_OWNER, true,  &HandleReloadReputationRewardRateCommand,       "", NULL },
            { "skill_discovery_template",     SEC_OWNER, true,  &HandleReloadSkillDiscoveryTemplateCommand,     "", NULL },
            { "skill_extra_item_template",    SEC_OWNER, true,  &HandleReloadSkillExtraItemTemplateCommand,     "", NULL },
            { "skill_fishing_base_level",     SEC_OWNER, true,  &HandleReloadSkillFishingBaseLevelCommand,      "", NULL },
            { "skinning_loot_template",       SEC_OWNER, true,  &HandleReloadLootTemplatesSkinningCommand,      "", NULL },
            { "smart_scripts",                SEC_OWNER, true,  &HandleReloadSmartScripts,                      "", NULL },
            { "spell_required",               SEC_OWNER, true,  &HandleReloadSpellRequiredCommand,              "", NULL },
            { "spell_area",                   SEC_OWNER, true,  &HandleReloadSpellAreaCommand,                  "", NULL },
            { "spell_bonus_data",             SEC_OWNER, true,  &HandleReloadSpellBonusesCommand,               "", NULL },
            { "spell_group",                  SEC_OWNER, true,  &HandleReloadSpellGroupsCommand,                "", NULL },
            { "spell_learn_spell",            SEC_OWNER, true,  &HandleReloadSpellLearnSpellCommand,            "", NULL },
            { "spell_loot_template",          SEC_OWNER, true,  &HandleReloadLootTemplatesSpellCommand,         "", NULL },
            { "spell_linked_spell",           SEC_OWNER, true,  &HandleReloadSpellLinkedSpellCommand,           "", NULL },
            { "spell_pet_auras",              SEC_OWNER, true,  &HandleReloadSpellPetAurasCommand,              "", NULL },
            { "spell_proc_event",             SEC_OWNER, true,  &HandleReloadSpellProcEventCommand,             "", NULL },
            { "spell_scripts",                SEC_OWNER, true,  &HandleReloadSpellScriptsCommand,               "", NULL },
            { "spell_target_position",        SEC_OWNER, true,  &HandleReloadSpellTargetPositionCommand,        "", NULL },
            { "spell_threats",                SEC_OWNER, true,  &HandleReloadSpellThreatsCommand,               "", NULL },
            { "spell_group_stack_rules",      SEC_OWNER, true,  &HandleReloadSpellGroupStackRulesCommand,       "", NULL },
            { "skyfire_string",               SEC_OWNER, true,  &HandleReloadSkyFireStringCommand,              "", NULL },
            { "waypoint_scripts",             SEC_OWNER, true,  &HandleReloadWpScriptsCommand,                  "", NULL },
            { NULL,                           0,                 false, NULL,                                           "", NULL }
        };
        static ChatCommand commandTable[] =
        {
            { "reload",         SEC_OWNER,  true,  NULL,                 "", reloadCommandTable },
            { NULL,             0,                  false, NULL,                               "", NULL }
        };
        return commandTable;
    }
