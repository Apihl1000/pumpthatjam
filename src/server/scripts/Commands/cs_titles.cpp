...
public:
    ...
    ChatCommand* GetCommands() const
    {
        ...
        {
            { "mask",           SEC_GM ,     false, &HandleTitlesSetMaskCommand,        "", NULL },
            { NULL,             0,                  false, NULL,                               "", NULL }
        };
        static ChatCommand titlesCommandTable[] =
        {
            { "add",            SEC_GM ,     false, &HandleTitlesAddCommand,            "", NULL },
            { "current",        SEC_GM ,     false, &HandleTitlesCurrentCommand,        "", NULL },
            { "remove",         SEC_GM ,     false, &HandleTitlesRemoveCommand,         "", NULL },
            { "set",            SEC_GM ,     false, NULL,              "", titlesSetCommandTable },
            { NULL,             0,                  false, NULL,                               "", NULL }
        };
        static ChatCommand commandTable[] =
        {
            { "titles",         SEC_GM ,     false, NULL,                 "", titlesCommandTable },
            { NULL,             0,                  false, NULL,                               "", NULL }
        };
        return commandTable;
    }
