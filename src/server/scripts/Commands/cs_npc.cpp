...
public:
    ...
    ChatCommand* GetCommands() const
    {
        ...
        {
            { "formation",      SEC_TRIAL_GM,      false, &HandleNpcAddFormationCommand,      "", NULL },
            { "item",           SEC_GM ,     false, &HandleNpcAddVendorItemCommand,     "", NULL },
            { "move",           SEC_GM ,     false, &HandleNpcAddMoveCommand,           "", NULL },
            { "temp",           SEC_GM ,     false, &HandleNpcAddTempSpawnCommand,      "", NULL },
            //{ TODO: fix or remove this command
            { "weapon",         SEC_OWNER,  false, &HandleNpcAddWeaponCommand,         "", NULL },
            //}
            { "",               SEC_GM ,     false, &HandleNpcAddCommand,               "", NULL },
            { NULL,             0,                  false, NULL,                               "", NULL }
        };
        static ChatCommand npcDeleteCommandTable[] =
        {
            { "item",           SEC_GM ,     false, &HandleNpcDeleteVendorItemCommand,  "", NULL },
            { "",               SEC_GM ,     false, &HandleNpcDeleteCommand,            "", NULL },
            { NULL,             0,                  false, NULL,                               "", NULL }
        };
        static ChatCommand npcFollowCommandTable[] =
        {
            { "stop",           SEC_GM ,     false, &HandleNpcUnFollowCommand,          "", NULL },
            { "",               SEC_GM ,     false, &HandleNpcFollowCommand,            "", NULL },
            { NULL,             0,                  false, NULL,                               "", NULL }
        };
        static ChatCommand npcSetCommandTable[] =
        {
            { "allowmove",      SEC_OWNER,  false, &HandleNpcSetAllowMovementCommand,  "", NULL },
            { "deathstate",     SEC_GM ,     false, &HandleNpcSetDeathStateCommand,     "", NULL },
            { "entry",          SEC_OWNER,  false, &HandleNpcSetEntryCommand,          "", NULL },
            { "factionid",      SEC_GM ,     false, &HandleNpcSetFactionIdCommand,      "", NULL },
            { "flag",           SEC_GM ,     false, &HandleNpcSetFlagCommand,           "", NULL },
            { "level",          SEC_GM ,     false, &HandleNpcSetLevelCommand,          "", NULL },
            { "link",           SEC_GM ,     false, &HandleNpcSetLinkCommand,           "", NULL },
            { "model",          SEC_GM ,     false, &HandleNpcSetModelCommand,          "", NULL },
            { "movetype",       SEC_GM ,     false, &HandleNpcSetMoveTypeCommand,       "", NULL },
            { "phase",          SEC_GM ,     false, &HandleNpcSetPhaseCommand,          "", NULL },
            { "spawndist",      SEC_GM ,     false, &HandleNpcSetSpawnDistCommand,      "", NULL },
            { "spawntime",      SEC_GM ,     false, &HandleNpcSetSpawnTimeCommand,      "", NULL },
            //{ TODO: fix or remove these commands
            { "name",           SEC_GM ,     false, &HandleNpcSetNameCommand,           "", NULL },
            { "subname",        SEC_GM ,     false, &HandleNpcSetSubNameCommand,        "", NULL },
            //}
            { NULL,             0,                  false, NULL,                               "", NULL }
        };
        static ChatCommand npcCommandTable[] =
        {
            { "info",           SEC_OWNER,  false, &HandleNpcInfoCommand,              "", NULL },
            { "move",           SEC_GM ,     false, &HandleNpcMoveCommand,              "", NULL },
            { "playemote",      SEC_OWNER,  false, &HandleNpcPlayEmoteCommand,         "", NULL },
            { "say",            SEC_TRIAL_GM,      false, &HandleNpcSayCommand,               "", NULL },
            { "textemote",      SEC_TRIAL_GM,      false, &HandleNpcTextEmoteCommand,         "", NULL },
            { "whisper",        SEC_TRIAL_GM,      false, &HandleNpcWhisperCommand,           "", NULL },
            { "yell",           SEC_TRIAL_GM,      false, &HandleNpcYellCommand,              "", NULL },
            { "tame",           SEC_GM ,     false, &HandleNpcTameCommand,              "", NULL },
            { "add",            SEC_GM ,     false, NULL,                 "", npcAddCommandTable },
            { "delete",         SEC_GM ,     false, NULL,              "", npcDeleteCommandTable },
            { "follow",         SEC_GM ,     false, NULL,              "", npcFollowCommandTable },
            { "set",            SEC_GM ,     false, NULL,                 "", npcSetCommandTable },
            { NULL,             0,                  false, NULL,                               "", NULL }
        };
        static ChatCommand commandTable[] =
        {
            { "npc",            SEC_TRIAL_GM,      false, NULL,                    "", npcCommandTable },
            { NULL,             0,                  false, NULL,                               "", NULL }
        };
        return commandTable;
    }
